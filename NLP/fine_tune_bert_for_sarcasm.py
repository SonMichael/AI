# -*- coding: utf-8 -*-
"""Fine-tune-Bert-for-sarcasm.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17hnj-RPVEGTlxq6nUho2KUC7ImAAtefe


Nâng độ chính xác cho bộ dữ liệu mỉa mai

Bert sử dụng Encoder của Transformer để học mối quan hệ một từ với những từ xung quanh và bổ sung mối quan hệ đó vào vector embedding của từng từ. Xem thêm về Video Transformer của team tại đây để hiểu về [cơ chế Attention](https://www.youtube.com/watch?v=_Zt23FA31co&t=1688s).
